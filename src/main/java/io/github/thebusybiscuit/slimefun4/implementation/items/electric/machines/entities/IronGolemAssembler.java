...
public class IronGolemAssembler extends AbstractEntityAssembler<IronGolem> {
    ...
    protected void constructMenu(BlockMenuPreset preset) {
        preset.addItem(
                1,
                new CustomItemStack(getHead(), "&7Coloque uma Abóbora aqui", "", "&fColoque uma Abóbora aqui"),
                ChestMenuUtils.getEmptyClickHandler());
        preset.addItem(
                7,
                new CustomItemStack(getBody(), "&7Coloque Blocos de Ferro aqui", "", "&fColoque Blocos de Ferro aqui"),
                ChestMenuUtils.getEmptyClickHandler());
        preset.addItem(
                13,
                new CustomItemStack(
