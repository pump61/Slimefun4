...
public class ProgrammableAndroid extends SlimefunItem
    ...
    public ProgrammableAndroid(
        ...
        new UniversalMenuPreset(getId(), "Android Programável") {
            ...
            public void newInstance(UniversalMenu menu, Block b) {
                ...
                menu.replaceExistingItem(
                        15, new CustomItemStack(HeadTexture.SCRIPT_START.getAsItemStack(), "&aIniciar/Retomar"));
                ...
                menu.replaceExistingItem(
                        17, new CustomItemStack(HeadTexture.SCRIPT_PAUSE.getAsItemStack(), "&4Pausar"));
                ...
                menu.replaceExistingItem(
                        ...
                        new CustomItemStack(
                                ...
                                "&bNúcleo de Memória",
                                "",
                                "&8\u21E8 &7Clique para abrir o editor de scripts"));
    ...
    public void openScript(Player p, SlimefunUniversalBlockData uniData, String sourceCode) {
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "",
                        "&7\u21E8 &eClique esquerdo &7para voltar ao painel"));
        ...
        for (int i = 1; i < script.length; i++) {
            ...
            if (i == script.length - 1) {
                ...
                if (hasFreeSlot) {
                    menu.addItem(
                            i,
                            new CustomItemStack(HeadTexture.SCRIPT_NEW.getAsItemStack(), "&7> Adicionar novo comando"));
                                        ...
                                        .getMessage(
                                                ...
                                                "android.scripts.instructions."
                                                        + Instruction.valueOf(script[i])
                                                                .name()),
                                "",
                                "&7\u21E8 &eClique esquerdo &7para editar",
                                "&7\u21E8 &eClique direito &7para excluir",
                                "&7\u21E8 &eShift + Clique direito &7para copiar"));
                menu.addMenuClickHandler(i, (pl, slot, item, action) -> {
    ...
    protected void openScriptDownloader(Player p, SlimefunUniversalBlockData uniData, int page) {
        ChestMenu menu = new ChestMenu("Scripts do Android");
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "&eEnviar script",
                        "",
                        "&6Clique &7para enviar o script atual",
                        "&7ao servidor"));
        ...
        menu.addItem(
                53,
                new CustomItemStack(
                        HeadTexture.SCRIPT_LEFT.getAsItemStack(), "&6> Voltar", "", "&7Voltar ao painel do Android"));
    ...
    public void openScriptEditor(Player p, SlimefunUniversalBlockData uniData) {
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "&4> Criar novo script",
                        "",
                        "&cApaga o script atual",
                        "&ce cria um novo em branco"));
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "&6> Baixar script",
                        "",
                        "&eBaixe scripts enviados por outros jogadores",
                        "&eUse diretamente ou modifique antes de usar"));
    ...
    protected void editInstruction(Player p, SlimefunUniversalBlockData uniData, String[] script, int index) {
        ...
        menu.addItem(
                9,
                new CustomItemStack(HeadTexture.SCRIPT_PAUSE.getAsItemStack(), "&fNão fazer nada"),
                (pl, slot, item, action) -> {
                    String code = deleteInstruction(script, index);
                    setScript(uniData, code);
    ...
    public List<ItemStack> getDisplayRecipes() {
        ...
        for (MachineFuel fuel : fuelTypes) {
            ...
            lore.add(ChatColors.color("&8\u21E8 &7Restante: " + NumberUtils.getTimeLeft(fuel.getTicks() / 2)));
            im.setLore(lore);
            item.setItemMeta(im);
            list.add(item);
        }
