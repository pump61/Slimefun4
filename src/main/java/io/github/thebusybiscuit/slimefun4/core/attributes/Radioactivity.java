...
public enum Radioactivity {
     ...
     */
    VERY_DEADLY(ChatColor.DARK_RED, "Mortal", 10);
    ...
    public @Nonnull String getLore() {
        return ChatColor.GREEN + "\u2622" + ChatColor.GRAY + " N\u00edvel de radia\u00e7\u00e3o: " + color
                + displayName;
    }
