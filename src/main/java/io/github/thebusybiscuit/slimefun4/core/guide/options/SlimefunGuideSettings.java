    ...
    private static void addHeader(Player p, ChestMenu menu, ItemStack guide) {
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "",
                        "&fServidor Eternity",
                        "&cNão reporte bugs desta versão no Discord/Github oficial",
                        "&cReporte bugs neste servidor",
                        "",
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "",
                        "&7Última atividade: &a" + NumberUtils.getElapsedTime(github.getLastUpdate()) + " atrás",
                        "&7Forks: &e" + github.getForks(),
                        "&7Stars: &e" + github.getStars(),
                        "",
                        "&7&oSlimefun 4 é um projeto da comunidade,",
                        "&7&oo código-fonte está disponível no GitHub",
                        "&7&oSe quiser contribuir para o projeto,",
                        "&7&oconsidere fazer uma contribuição!",
                        "",
                        "&7\u21E8 &eClique para ir ao repositório GitHub"));
        // @formatter:on
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "",
                        "&7Precisa de ajuda com itens ou máquinas?",
                        "&7Não sabe o que fazer?",
                        "&7Consulte nossa wiki mantida pela comunidade",
                        "&7e considere se tornar um editor!",
                        "",
                        "&7\u21E8 &eClique para visitar a Wiki"));
        // @formatter:on
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "",
                        "&7Slimefun é um projeto enorme, mas os add-ons",
                        "&7fazem o Slimefun brilhar de verdade",
                        "&7Dê uma olhada, talvez o add-on que você procura esteja lá!",
                        "",
                        "&7Add-ons instalados neste servidor: &b"
                                + Slimefun.getInstalledAddons().size(),
                        "",
                        "&7\u21E8 &eClique para ver os add-ons disponíveis para Slimefun4"));
        // @formatter:on
