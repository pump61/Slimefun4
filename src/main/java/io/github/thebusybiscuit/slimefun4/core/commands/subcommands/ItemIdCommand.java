            ...
            if (sender.hasPermission("slimefun.command.id")) {
                ...
                if (item.getType() != Material.AIR) {
                    ...
                    if (sfItem != null) {
                        ...
                        var msg = new TextComponent("ID deste item: ");
                        var idMsg = new TextComponent(sfId);
                        idMsg.setUnderlined(true);
                        idMsg.setItalic(true);
                        idMsg.setColor(ChatColor.GRAY);
                        idMsg.setHoverEvent(
                                new HoverEvent(HoverEvent.Action.SHOW_TEXT, new Text("Clique para copiar")));
                    ...
                    sender.sendMessage(ChatColors.color("&bSegure o item na mão principal!"));
                }
            } else {
