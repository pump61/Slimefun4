        ...
        try {
            ...
            if (readExecutorThread + writeExecutorThread > connectionPoolSize) {
                plugin.getLogger()
                        .log(
                                Level.WARNING,
                                "Tamanho do pool de conexões block-storage menor que o total de threads de leitura/escrita, pode causar problemas de desempenho");
            }
            ...
            if (blockStorageConfig.getBoolean("delayedWriting.enable")) {
                plugin.getLogger().log(Level.INFO, "Salvamento com atraso ativado");
            ...
            plugin.getLogger()
                    .log(Level.SEVERE, "Falha ao carregar o adaptador de armazenamento de blocos Slimefun", e);
            return;
        }
        ...
        try {
            ...
            if (readExecutorThread + writeExecutorThread > connectionPoolSize) {
                plugin.getLogger()
                        .log(
                                Level.WARNING,
                                "Tamanho do pool de conexões profile-storage menor que o total de threads de leitura/escrita, pode causar problemas de desempenho");
            }
            ...
            plugin.getLogger().log(Level.SEVERE, "Falha ao carregar o adaptador de perfil do jogador", e);
        }
    }
